...
- Api.Service - Gerar Token
    ...
    Cria um método que cria o token
    ...
    Cria um método que retorna uma respota para o token criado
    ...
    Cria o método que verifica se o uruario existe e faz a configuração do token e chama os outros métodos!
